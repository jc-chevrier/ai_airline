...
public class ReservationAgent extends Agent {
    ...
    protected void setup() {
        System.out.println("Je suis l'agent de la compagnie aérienne qui écoute les requêtes de réservation : " +
        ...
        addBehaviour(new TickerBehaviour(this, 1000) {
            ...
            protected void onTick() {
                System.out.println("Tick listening reservation");

                // Wait for incoming message
                ACLMessage msg = receive();
                if (msg != null) {
                    System.out.println("Listening reservation agent === Message received from " + msg.getSender().getLocalName());
//                  System.out.println("Internal agent === Message content is : " + getLocalName() + " <- " + msg.getContent());
                    try {
                        ...
                        System.err.println("AGENT LISTEN RESERVATION CRASH");
