CREATE TABLE CITY (
    ...
    TIME_TO_PARIS NUMERIC(8) NOT NULL, -- Durée du trajet vers Paris en secondes.
...
CREATE TABLE GLOBAL (
      ...
      BALANCE DECIMAL(20, 2) NOT NULL DEFAULT 11000000,
      BALANCE_INITIALIZATION DECIMAL(20, 2) NOT NULL DEFAULT 10000000,
